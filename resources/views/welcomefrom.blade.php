...
<body>
    <div class="container">
        ...
        <div class="chat-box" id="chatBox">
            ...
            <div class="message bot">✅ Welcome, John Smith!</div>
            <div class="message bot">Your balance: £3,450.75</div>
            <div class="message bot">What do you want to do today? Type or say:<br>• "What's my balance?"<br>• "Last transaction?"<br>• "Branch hours?"<br>• "My profile?"</div>
        </div>
        ...
        <div class="feature-card">
            <div class="voice-controls" id="voiceControls" style="display: block; text-align: center; margin: 15px 0px;">
                ...
                <div id="status" class="status">🔐 Logging in...</div>
            </div>
