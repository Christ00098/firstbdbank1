...
<head>
  ...
  <link rel="icon" type="image/png" href="bank-logo.png">
  <style>
    ...
    <div class="login-section" id="loginSection">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            <input id="account_number" type="text" class="form-control @error('account_number') is-invalid @enderror" name="account_number" placeholder="Account Number (e.g. 9459069941)" value="{{ old('account_number') }}" required autocomplete="off" autofocus style="width: 100%;">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="password" required autocomplete="current-password" style="width: 100%;">
...
<!--
    ...
    <div class="feature-card">
      <div class="voice-controls" id="voiceControls" style="display:none; text-align:center; margin:15px 0;">
    ...
    <script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon="{&quot;version&quot;:&quot;2024.11.0&quot;,&quot;token&quot;:&quot;80b318d5115d4989ac3c6ba3762f885e&quot;,&quot;r&quot;:1,&quot;server_timing&quot;:{&quot;name&quot;:{&quot;cfCacheStatus&quot;:true,&quot;cfEdge&quot;:true,&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfSpeedBrain&quot;:true},&quot;location_startswith&quot;:null}}" crossorigin="anonymous"></script>
